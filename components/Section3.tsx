...
function Section3() {
    return (
        <>
            {/* Centered text */}
            <div className="text-center lg:mt-56 justify-center m-10 ">
                <h1 className="text-2xl md:text-4xl  font-bold ">
                    WHY CHOOSE <span className="text-blue-600">US</span>
                </h1>
            </div>
            <div className="justify-center lg:flex m-7 items-center h-screen">
                ...
                <div className="flex flex-col  justify-center items-center mb-4 text-center z-10">
                    ...
                    <h5 className="text-xl font-bold mb-2">Elevate Learning Experiences</h5>
                    <p className="text-base">Harness the transformative power of motivation to enhance educational outcomes</p>
                </div>
