...
function Section4() {
    return (
        <div className='bg-[#4285F4] w-full h-full' >

            <div className='w-full flex flex-col m-8 mt-36 z-10 text-left text-wrap md:px-2 whitespace-nowrap'>
                <h5 className='font-bold text-3xl m-4 text-white'>Our <span className='text-[#022061]'>Courses</span></h5>
